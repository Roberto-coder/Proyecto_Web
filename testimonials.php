...
<php lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item active" href="testimonials.php">Testimonios</a>
    ...
    <!-- Page Content -->
    <div class="page-heading about-heading header-text" style="background-image: url(assets/images/img1.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                <h4>Juan Perez</h4>
                <p class="n-m"><em>"Buen trabajo."</em></p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="service-item">
              ...
              <div class="down-content">
                <h4>Carlos</h4>
                <p class="n-m"><em>"Buen servicio."</em></p>
              </div>
            </div>
          </div>
        </div>
